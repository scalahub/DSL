 ...
 */
/**
 * This is used for converting Wildcard to Regex. 
 * For ease of use, we allow wildcards (globs) in addition to Regex
 * Internally the wildcards are converted to Regex. 
 * This file is used for that.
 * 
 * Code copied from:
 * 
 * http://grepcode.com/file/repo1.maven.org/maven2/org.apache.hadoop/hadoop-common/0.23.1/org/apache/hadoop/fs/GlobPattern.java
 * 
 */
